 ...
 $('.pagination-container').empty()
     ...
     const setLimit = Math.ceil(parseInt(limit)/3)
     const currentButton = parseInt(index)
     $('.pagination-container').append(`
     <span class="page-item" id="CaretLeftFill">
      <a class="page-link"  href="?page=${currentButton-1}">Previous</a>
     </span>`)
    $('.pagination-container').append(`<div id="pagination" class="d-flex"></div>`)
     ...
     pagedot.append($(`
       <span class="page-item ${voteable+dotinit}">
         <a  class="page-link" data-page="${el}" href="?page=${el}">${el}</a>
       </span>
       `)[0])
    })
    ...
    <span class="page-item" id="CaretRightFill">
       <a class="page-link" href="?page=${currentButton+1}">Next</a>
    </span>`)
